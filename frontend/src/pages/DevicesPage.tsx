...
export const DevicesPage = () => {
  ...
  useEffect(() => { fetchDevices(); fetchPlaylists(); }, [fetchDevices, fetchPlaylists]);
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        ...
        <button onClick={() => { setEditingDevice(null); setFormData({ deviceId: '', name: '', description: '', location: '' }); setShowModal(true); }} className="btn-primary">+ Add Device</button>
      </div>
